...
export default function DummyTicket() {
  ...
  return (
    <>
      <Helmet>
        <title>Dummy Ticket From USD 13 | Instant, Verifiable, & Affordable</title>
        <link rel="canonical" href="https://www.dummyticket365.com/dummy-ticket" />
      ...
      />
      <Process title="Your Dummy Ticket in 3 Easy Steps" subtitle="How To Book Your Dummy Ticket" />
      <About />
