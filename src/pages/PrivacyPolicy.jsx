    ...
    <PrimarySection pb="50px">
      <Container>
        ...
        <Paragraph fontSize="20px" mt="20px">
          At Dummy Ticket 365, your privacy is of utmost importance to us. This
          Privacy Policy outlines how we collect, use, and protect your personal
          information when you use our website (https://www.dummyticket365.com).
        </Paragraph>
        ...
        <Paragraph fontSize="20px">
          <ol>
            <li>
              ...
              information by contacting us at info@dummyticket365.com.
            </li>
            <li>
