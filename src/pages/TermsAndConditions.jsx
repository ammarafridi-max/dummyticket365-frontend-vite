    ...
    <PrimarySection pb="50px" pt="50px">
      <Container>
        ...
        <Paragraph fontSize="20px" mt="20px">
          Welcome to Dummy Ticket 365! By using our website
          (https://www.dummyticket365.com), you agree to comply with and be
        ...
        <Paragraph fontSize="20px">
          <ol>
            <li>
              Dummy Ticket 365 provides travel-related services, including the
        ...
        <Paragraph fontSize="20px">
          <ol>
            ...
            <li>
              Dummy Ticket 365 is not responsible for any consequences arising
        ...
        <Paragraph fontSize="20px">
          <ol>
            <li>
              All content on the Dummy Ticket 365 website, including text,
              graphics, logos, and software, is the property of Dummy Ticket 365
        ...
        <Paragraph fontSize="20px">
          <ol>
            <li>
              Dummy Ticket 365 does not guarantee visa approval or any specific
