...
export default function SelectTitle({ value, onChange, className = '' }) {
  ...
  return (
    <div
      className={`relative bg-transparent rounded-md cursor-pointer p-0 ${className}`}
    >
      <div
        className="flex items-center gap-2 bg-white text-[14.5px] text-gray-80 text-left px-4 py-2.5 rounded-lg border-[1.5px] border-gray-300 font-nunito"
