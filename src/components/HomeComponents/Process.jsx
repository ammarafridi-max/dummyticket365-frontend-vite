...
const steps = [
  ...
  {
    title: 'Choose Your Onward Flight',
  ...
  },
  {
    ...
    text: 'Complete your payment securely and receive your {keyword} instantly by email. Your onward ticket is ready for airline check-in or immigration verification.',
  },
];

export default function Process({
  title = 'Get Your Dummy Ticket in 3 Simple Steps',
  subtitle = 'Learn how to book a dummy ticket in minutes, using real airline itineraries and a verifiable PNR delivered instantly to your email.',
  keyword = 'dummy ticket',
}) {
  return (
    <PrimarySection className="pt-15 lg:pt-25" id="process">
      <Container>
